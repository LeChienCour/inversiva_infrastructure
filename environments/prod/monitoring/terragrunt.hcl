...
inputs = {
  ...
  alert_email_addresses      = ["ops-team@example.com"]
  ...
  enable_dashboard          = true    # Enable for production visibility
  enable_performance_alarms = true    # Keep essential performance monitoring
  enable_cost_alarms        = true    # Keep cost monitoring
  enable_sns_alerts         = true    # Keep alerts
  cost_alarm_threshold      = "3"     # Alert if daily cost > $3
}