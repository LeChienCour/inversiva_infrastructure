...
inputs = {
  ...
  minimum_tls_version = include.env.locals.dev_config.cloudfront.minimum_tls_version
  
  # All CloudFront configuration from environment
  price_class = include.env.locals.dev_config.cloudfront.price_class
  enable_ipv6 = include.env.locals.dev_config.cloudfront.enable_ipv6
  enable_monitoring = include.env.locals.dev_config.cloudfront.enable_monitoring
  ...
  content_security_policy = include.env.locals.dev_config.cloudfront.content_security_policy
  
  # Custom headers (minimal for dev)
  custom_headers = []
  
  # CORS configuration from environment
  cors_allow_credentials = include.env.locals.dev_config.cors.allow_credentials
  cors_allow_headers = include.env.locals.dev_config.cors.allow_headers
  cors_allow_methods = include.env.locals.dev_config.cors.allow_methods
  cors_allow_origins = include.env.locals.dev_config.cors.allow_origins
  cors_expose_headers = include.env.locals.dev_config.cors.expose_headers
  cors_max_age_seconds = include.env.locals.dev_config.cors.max_age_seconds
  
  # Error handling from environment
  custom_error_responses = include.env.locals.dev_config.cloudfront.custom_error_responses
  
  # Logging configuration from environment
  logging_bucket = include.env.locals.dev_config.cloudfront.logging_bucket
  logging_include_cookies = include.env.locals.dev_config.cloudfront.logging_include_cookies
